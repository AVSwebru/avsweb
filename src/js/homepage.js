...
(function () {
  ...
  if (document.querySelector('.js-homepage')) {
    ...
    feedbackTween
      .from(document.querySelector('.js-feedback'), 1.5, {
        ease:
          Expo.easeOut, y: 400, opacity: 0
      })
    ...
    clientsTween
      .staggerFrom(document.querySelectorAll('.js-client-item'), 2, {
        ease:
          Expo.easeOut, y: 300, opacity: 0
      }, 0.25)
    ...
    contactsTween
      .staggerFrom(document.querySelectorAll('.js-contacts-item'), 2, {
        ease:
          Expo.easeOut, y: 300, opacity: 0
      }, 0.25)
      .from(document.querySelectorAll('.js-contacts-item-border'), 2, {
        ease:
          Expo.easeOut, transformOrigin: 'left', scaleX: 0
      }, '-=1')
